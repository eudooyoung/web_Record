...
이 때는 작은 따옴표, 큰 따옴표 대신 백틱(`)을 사용해 표현한다.
*/
...
console.log(hello('두영'));

// 함수 표현식 
// hello2 식별자       hello 이름
// 함수를 변수에 담을 수 있고, 또 호출 할 수 있다.
...
console.log(hello2('두영'));

// 이름이 없어도 가능
let hello3 = function (name) {
    return `${name} 님 안녕하세요`;
    // return이 암묵적으로 생략 되어있고, 명시적으로 지정하지 않으면 undefined 반환.
}

console.log(hello3('두영'));
